...
import { X, ChevronDown, ChevronRight, Home, Settings, HelpCircle, Search, Bell, User } from 'lucide-react';
...
const NotificationCenter = ({ notifications = [], onClearAll, onMarkAsRead }) => {
  const [isOpen, setIsOpen] = useState(false);
...
export { Breadcrumb, SearchBar, NotificationCenter, UserMenu, HelpButton };
